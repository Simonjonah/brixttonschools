                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach ($view_examsfornids as $view_examsfornid)
                          @if ($view_examsfornid->student['programname'] == 'NID Computer Hardware Engineering Technology' && $view_examsfornid->registercourse['semester'] == 'First Semester' && $view_examsfornid->registercourse['level'] == '100L')
                          <tr>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_examsfornids as $view_examsfornid)
                        @if ($view_examsfornid->student['programname'] == 'NID Computer Hardware Engineering Technology' && $view_examsfornid->registercourse['semester'] == 'Second Semester' && $view_examsfornid->registercourse['level'] == '100L')
                        <tr>
                          <td><a href="viewstudentsexams/{{ $view_examsfornid->student['ref_no'] }}">{{ $view_examsfornid->student['surname'] }}</a></td>
                          <td>{{ $view_examsfornid->student['fname'] }}</td>
                          <td>{{ $view_examsfornid->student['middlename'] }}</td>
                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        @foreach ($view_examsfornids as $view_examsfornid)
                            @if ($view_examsfornid->student['programname'] == 'NID Computer Hardware Engineering Technology' && $view_examsfornid->registercourse['semester'] == 'First Semester' && $view_examsfornid->registercourse['level'] == '200L')
                            <tr>
                              <td><a href="viewstudentsexams/{{ $view_examsfornid->student['ref_no'] }}">{{ $view_examsfornid->student['surname'] }}</a></td>
                              <td>{{ $view_examsfornid->student['fname'] }}</td>
                              <td>{{ $view_examsfornid->student['middlename'] }}</td>
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                @foreach ($view_examsfornids as $view_examsfornid)
                    @if ($view_examsfornid->student['programname'] == 'NID Computer Hardware Engineering Technology' && $view_examsfornid->registercourse['semester'] == 'Second Semester' && $view_examsfornid->registercourse['level'] == '200L')
                    <tr>
                      <td><a href="viewstudentsexams/{{ $view_examsfornid->student['ref_no'] }}">{{ $view_examsfornid->student['surname'] }}</a></td>
                      <td>{{ $view_examsfornid->student['fname'] }}</td>
                      <td>{{ $view_examsfornid->student['middlename'] }}</td>
