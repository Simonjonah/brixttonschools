      ...
      <div class="col-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td>{{ $printsingle_payments->student['fname']}}</td>
            <td>{{ $printsingle_payments->student['middlename'] }}</td>
            <td>{{ $printsingle_payments->student['regnumber'] }}</td>
            <td>{{ $printsingle_payments->course_period }}</td>
            
            <td>₦ {{ $printsingle_payments->amount }}</td>
          </tr>
      ...
      <div class="col-6">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <th>Program</th>
              <td>{{ $printsingle_payments->student['programname'] }}</td>
            </tr>
            <tr>
              <th>Semester</th>
