          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      @foreach ($disall_payments as $disall_payment)
                         @if ($disall_payment->student['programname'] == 'Diploma Hardware Maintenance and Repairs')
                         <tr>
                            <td><a href="viewstudentaccount/{{ $disall_payment->student['ref_no'] }}" target="_blank" rel="noopener noreferrer"> {{ $disall_payment->student['ref_no'] }}</a></td>
                            ...
                            <td>@if ($disall_payment->status == null)
                             ...
                             <td><a href="{{ url('burser/approvedsinglepayments/'.$disall_payment->id) }}" class="btn btn-sm btn-success float-left">Approved </a></td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ route('burser.printsinglepaymentspdfacc') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print All</a>
