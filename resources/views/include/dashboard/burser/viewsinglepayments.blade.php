                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>@if ($views_payments->status == null)
                         ...
                         <td><a href="{{ url('burser/approvedsinglepayments/'.$views_payments->id) }}" class="btn btn-sm btn-success float-left">Approved </a></td>
                ...
                <div class="col-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <th>Print</th>
                        <td><a href="{{ url('burser/printsinglepaymentspdfs/'.$views_payments->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                        </td>
                      </tr>
                    </table>
                  </div>
