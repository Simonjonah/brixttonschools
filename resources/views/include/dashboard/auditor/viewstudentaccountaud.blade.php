          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  {{ $view_student->quali_obtain }}
                  <p>study Area</p>
                  {{ $view_student->studyarea }} 
                  <p>study Name of School</p>
                  {{ $view_student->institname }} 
                  <p>Grade Pass</p>
                  {{ $view_student->gradepass }} 
                </p>
                ...
                <p class="text-muted">{{ $view_student->sessionapplied }} </p>
                ...
                <p class="text-muted">
                  <span class="tag tag-danger">{{ $view_student->course_title }}</span>
                  
                </p>
                <strong><i class="fas fa-pencil-alt mr-1"></i> ₦ {{ $view_student->course_amount }}</strong>
            ...
            <div class="card card-primary">
              <div class="card-header">
                <div class="card-title">
                  All Qualification submitted by {{ $view_student->ref_no }} {{ $view_student->fname }}
                </div>
              </div>
              <div class="card-body">
                <div class="row">
