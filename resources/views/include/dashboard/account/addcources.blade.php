                ...
                <div class="col-lg-6">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      @enderror value="{{ old('course_title') }}" id="exampleInputEmail1" placeholder="Course title">
                    </div>
                    @error('course_title')
                    ...
                    <div class="form-group">
                      ...
                      @enderror value="{{ old('course_code') }}" id="exampleInputEmail1" placeholder="Course Code">
                    </div>
                    @error('course_code')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group">
                      ...
                      @enderror value="{{ old('course_amount') }}" id="exampleInputEmail1" placeholder="Course Amount">
                    </div>
                    @error('course_amount')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
