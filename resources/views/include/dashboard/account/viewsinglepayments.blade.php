                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $views_payments->student_firstname }}</td>
                        <td>{{ $views_payments->student_middlename }}</td>
                        ...
                        <td>@if ($views_payments->status == null)
                         ...
                         @endif</td>
                         <td>₦ {{ $views_payments->course_amount }}</td>
                ...
                <div class="col-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <th>Program</th>
                        <td>{{ $views_payments->course_programs}}</td>
                      </tr>
                      ...
                      <tr>
                        <th>Reg Number</th>
                        <td>{{ $views_payments->student_regnumber}}</td>
                      </tr>

                      <tr>
                        <th>Print</th>
                        <td><a href="{{ url('account/printsinglepaymentspdfs/'.$views_payments->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                        </td>
                      </tr>
                    </table>
                  </div>
