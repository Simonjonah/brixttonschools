                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>@if ($printall_payment->status == null)
                         ...
                         <td><a href="viewsinglepayments/{{ $printall_payment->id }}" class="btn btn-sm btn-primary float-left">View </a></td>
                         {{-- <td><a href="allthestudents" class="btn btn-sm btn-success float-left">Approved </a></td> --}}
                         <td><a href="{{ url('account/approvedsinglepayments/'.$printall_payment->id) }}" class="btn btn-sm btn-success float-left">Approved </a></td>
