                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="course_title1" class="form-control">
                          ...
                          <option value="Introduction to WAN Technology">Introduction to WAN Technology</option>
                          <option value="Data & Network Security">Data & Network Security</option>
                          <option value="Power & Network Management">Power & Network Management</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="course_code1" class="form-control">
                          <option value="NSS 211">NSS 211</option>
                          <option value="NSS 212">NSS 212</option>
                          <option value="NSS 213">NSS 213</option>
                          <option value="NSS 214">NSS 214</option>
                          <option value="NSS 215">NSS 215</option>
                          <option value="NSS 216">NSS 216</option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="course_code5" class="form-control">
                            <option value="NIDNETFIRSTSEMLEVEL200">NID</option>
