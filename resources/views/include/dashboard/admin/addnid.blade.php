            ...
            <div class="container">
              <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input  type="file" class="form-control" required name="courseimages"  @error('courseimages') is-invalid @enderror"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <textarea class="textarea" required name="course_contents" class="form-control" @error('pubmessage') is-invalid @enderror" placeholder="Place some text here"
