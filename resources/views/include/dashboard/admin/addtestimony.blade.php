                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ old('student_firstname') }}" name="student_firstname" placeholder="Stusent First Name">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ old('student_lastname') }}" name="student_lastname" placeholder="Stusent Last Name">
                      </div>
                    </div>
