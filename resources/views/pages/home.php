<?php require_once 'common/header.php'; ?>
    ...
    <section class="main-slider style-four">
        <div class="main-slider-carousel owl-carousel owl-theme">
        	...
        	<?php if (count($main_site_sliders) > 0): ?>
    		<?php foreach ($main_site_sliders as $main_site_slider): ?>
            <div class="slide" style="background-image:url(<?php echo HOME. $main_site_slider['images']; ?>); background-size: cover; background-repeat: no-repeat; background-position: center; height: 500px;">
                <div class="auto-container">
					<div class="content">
						<div class="title"><?php echo $main_site_slider['nameofschool']; ?></div>
						<h2 style="color: #fff;"><?php echo $main_site_slider['nameofschool']; ?></h2>
						<div class="text"><h2><?php echo $main_site_slider['description']; ?></h2></div>
						<div class="link-box">
			...
			<div class="sec-title-three">
				<div class="clearfix">
					...
					<div class="pull-right">
						<div class="text">For us at NCI Schools, passion is our sole driving force towards molding our pupils into their excellent states.
			...
			<div class="row clearfix">
				...
				<div class="image-column col-lg-5 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image-1"><img src="<?php echo HOME; ?>images/resource/vic.jpg" alt=""></div>
					</div>
				</div>
	...
	<section class="services-section-ten">
		<div class="auto-container">
			...
			<div class="sec-title-three centered">
				...
				<h2 style="color: purple;">Close personal attention to each child is guaranteed</h2>
				<section class="testimonial-section-three">
					<div class="auto-container">
						...
						<div class="two-item-carousel owl-carousel owl-theme">
							...
							<?php if (count($fact_sliders) > 0): ?>
    						<?php foreach ($fact_sliders as $fact_slider): ?>

							<div class="testimonial-block-four">
								<div class="inner-box">
									<div class="text"><?php echo $fact_slider['message']; ?></div>
								</div>
							</div>
						<?php endforeach; ?>
					<?php endif; ?>
					...
					<h2 style="text-align: center; color: purple; margin-bottom: 50px; font-weight: bold;">Academic Activities</h2>
	...
	<!-- Counter Section -->
	<section class="counter-section" style="background-image:url(<?php echo HOME; ?>images/background/bsch2.jpg)">
		<div class="auto-container">
			<!-- Fact Counter -->
	...
	<section class="team-section-two" >
		<div class="auto-container">
			...
			<div class="sec-title-three centered">
				...
				<h2 style="color: purple;">We have a large <br> experts team</h2>
			</div>
					...
					<div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							...
							<ul class="social-box">
								...
								<li><a href="<?php echo $member_team['email']; ?>" class="fa fa-google-plus"></a></li>
							</ul>
						</div>
					...
					<div class="inner-box">
						<div class="row clearfix">
							...
							<div class="image-column col-lg-3 col-md-4 col-sm-12">
								<div class="inner-column">
									<div class="image">
										<img style="width: 100%; height: 250px;" src="<?php echo HOME.$post['images']; ?>" alt="" />
									</div>
								</div>
							</div>
							<!-- Content Column -->
							<div class="content-column col-lg-9 col-md-8 col-sm-12">
								<div class="inner-column">
									<div class="text"><span class="icon flaticon-left-quote"></span><?php echo $post['message']; ?></div>
									<!-- <h5>Amber Lee</h5> -->
	...
	<section class="news-section-two alternate">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<?php  if (count($galleries) > 0): ?>
                  <?php foreach ($galleries as $gallerie): 
                    $id = $gallerie['id']; $date = date('d-m-Y', strtotime($gallerie['date'])); $images = $gallerie['images']; ?>
				<div class="news-block-two brown col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<img style="width: 100%; height: 300px;" src="<?php echo HOME. $gallerie['images']; ?>" alt="" />
							<div class="overlay-box">
								<a href="<?php echo HOME. $gallerie['images']; ?>" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
							</div>
						</div>
						<div class="lower-content">
							
							<h7><?php echo $gallerie['description']; ?></h7>
			...
			<div class="text-center" style="padding-top: 60px;">
				<a href="<?php echo HOME; ?>facilities" class="theme-btn btn-style-fourteen">View More</a>
			</div>
	...
	<section class="blog-Press-section">
		<div class="auto-container">
				...
				<div class="news-block-three col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
                    		...
                    		<img style="width: 1000px; height: 250px;" src="<?php echo HOME.$press_releases['images']; ?>" alt=""></a></h2></span>
							
						</div>
						<div class="lower-content">
							<ul class="post-meta">
								<li><span class="fa fa-calendar"></span><?php echo $press_releases['postdate']; ?></li>
			...
			<div class="text-center">
				<a href="<?php echo HOME; ?>blog" class="theme-btn btn-style-fourteen">View All Press</a>
			</div>
		</div>
	</section>
		...
		<div class="auto-container">
			<div class="carousel-outer">
                ...
                <ul class="sponsors-carousel owl-carousel owl-theme">
                	<?php if (count($posts) > 0): ?>
                    <?php foreach ($posts as $post): ?>
                    <li><div class="image-box"><a href="#"><img style="width: 100%; height: 150px;" src="<?php echo HOME.$post['images']; ?>" alt=""></a></div></li>
			...
			<div class="row clearfix">
				...
				<div class="title-column col-lg-4 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="text">If you want to discuss on how to enroll your wards at NCI SCHOOLS, Please shedule a meeting through this contact form.</div>
					</div>
				</div>
			</div>
		</div>
