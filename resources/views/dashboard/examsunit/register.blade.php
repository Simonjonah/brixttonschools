...
<div class="register-box">
  <div class="register-logo">
    <a href="/"><b>Exam's Unit</b> Registration</a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="{{ route('examsunit.createexamunit') }}" method="post" enctype="multipart/form-data">
        @csrf
  ...
  @endif
        ...
        <div class="input-group mb-3">
          <input name="images" type="file" required class="form-control" @error('images') is-invalid @enderror"
          value="{{ old('images') }}" placeholder="Last name">
