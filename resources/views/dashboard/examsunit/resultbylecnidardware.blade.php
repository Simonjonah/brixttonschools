                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @if ($displayallnidsoft->student['programname'] == 'NID Computer Hardware Engineering Technology' && $displayallnidsoft->semester == 'First Semester' && $displayallnidsoft->level == '100L')
                          <tr>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach ($displayallnidsofts as $displayallnidsoft)
                      @if ($displayallnidsoft->student['programname'] == 'NID Computer Hardware Engineering Technology' && $displayallnidsoft->semester == 'Second Semester' && $displayallnidsoft->level == '100L')
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach ($displayallnidsofts as $displayallnidsoft)
                      @if ($displayallnidsoft->student['programname'] == 'NID Computer Hardware Engineering Technology' && $displayallnidsoft->semester == 'First Semester' && $displayallnidsoft->level == '200L')
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach ($displayallnidsofts as $displayallnidsoft)
                      @if ($displayallnidsoft->student['programname'] == 'NID Computer Hardware Engineering Technology' && $displayallnidsoft->semester == 'Second Semester' && $displayallnidsoft->level == '200L')
