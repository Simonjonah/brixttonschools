        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="{{ route('auditor.admittedstureg') }}">Students</a></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="{{ route('auditor.coursesforcert') }}">Certificate in Data Courses</a> </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="{{ route('auditor.coursesford1') }}">D1 Courses</a> </span>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <ul class="users-list clearfix">
                      @foreach ($view_lecturers as $view_lecturer)
                        ...
                        <li>
                          ...
                          <a class="users-list-name" href="viewstudentauditor/{{ $view_lecturer->ref_no}}">{{ $view_lecturer->fname}} {{ $view_lecturer->lname}}</a>
                  ...
                  <div class="card-footer text-center">
                    <a href="{{ route('auditor.viewlecturersreg') }}">View All Users</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
            ...
            <div class="card">
                  ...
                  <table class="table m-0">
                    ...
                    <tbody>
                      @foreach ($view_students as $view_student)
                        ...
                        <tr>
                          <td><a href="viewstudentauditor/{{ $view_student->ref_no}}">{{ $view_student->ref_no }}</a></td>
              ...
              <div class="card-footer clearfix">
                <a href="allstudentsaud" class="btn btn-sm btn-info float-left">View Students</a>
                  ...
                  <table class="table m-0">
                    ...
                    <tbody>
                      @foreach ($getyour_payments as $getyour_payment)
                        ...
                        <tr>
                          <td><a href="viewstudentauditor/{{ $getyour_payment->student['ref_no']}}">{{ $getyour_payment->student['ref_no'] }}</a></td>
                          <td>{{ $getyour_payment->student['surname'] }}</td>
                          <td>{{ $getyour_payment->student['fname'] }}</td>
                          <td>{{ $getyour_payment->student['programname'] }}</td>
                          ...
                          <td><a href="{{ url('auditor/viewsinglepayments/'.$getyour_payment->id) }}" class="btn btn-sm btn-success float-left">View </a></td>
          ...
          <div class="col-md-4">
            ...
            <div class="info-box mb-3 bg-success">
              ...
              <div class="info-box-content">
                <span class="info-box-text">NID Software Students</span>
                <span class="info-box-number">{{ $count_softs }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            <div class="info-box mb-3 bg-danger">
              ...
              <div class="info-box-content">
                <span class="info-box-text">NID Network Students</span>
                <span class="info-box-number">{{ $count_networks }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            <div class="info-box mb-3 bg-info">
              ...
              <div class="info-box-content">
                <span class="info-box-text">NID Hardware Students</span>
                <span class="info-box-number">{{ $count_hardware }}</span>
              </div>

              {{-- <div class="info-box-content">
                <span class="info-box-text">Maintenance</span>
                <span class="info-box-number">{{ $count_hardmti }}</span>
              </div> --}}
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            ...
            <div class="info-box mb-3 bg-secondary">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Maintenance Students</span>
                <span class="info-box-number">{{ $count_hardmti }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
