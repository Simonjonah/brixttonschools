        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="{{ route('burser.admittedstureg') }}">Students</a></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="{{ route('burser.coursesforcert') }}">Certificate in Data Courses</a> </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="{{ route('burser.coursesford1') }}">D1 Courses</a> </span>
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  ...
                  <div class="card-footer text-center">
                    <a href="{{ route('burser.viewlecturersreg') }}">View All Users</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
                  ...
                  <table class="table m-0">
                    ...
                    <tbody>
                      @foreach ($getyour_payments as $getyour_payment)
                        ...
                        <tr>
                          <td><a href="viewstudentburser/{{ $getyour_payment->student['ref_no']}}">{{ $getyour_payment->student['ref_no'] }}</a></td>
                          ...
                          <td><a href="{{ url('burser/viewsinglepayments/'.$getyour_payment->id) }}" class="btn btn-sm btn-success float-left">View </a></td>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="viewstudentburser/{{ $view_result->student['ref_no'] }}" class="product-title">{{ $view_result->student['surname'] }} <a href="singleresults/{{ $view_result->id }}" class="btn btn-primary">View</a>
