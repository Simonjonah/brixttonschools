                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($viewall_payments as $viewall_payment)
                      ...
                      <tr>
                        <td>{{ $viewall_payment->student_firstname }}</td>
                        <td>{{ $viewall_payment->student_middlename }}</td>
                        <td>{{ $viewall_payment->student_regnumber }}</td>
                       ...
                       <th><a href="{{ url('admin/confirmpayment/'.$viewall_payment->slug) }}" class="btn btn-sm bg-teal">
