                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($viewall_studentsinprogress as $viewall_studentsinprogres)
                      @if ($viewall_studentsinprogres->status = 'suspend')
                      <tr>
                        ...
                        <td><a href="{{ url('account/viewstudentaccount/'.$viewall_studentsinprogres->ref_no) }}"
                          class='btn btn-default'>
                           <i class="far fa-eye"></i>
                       </a></td>
                         <td><a href="{{ url('account/editstudentexam/'.$viewall_studentsinprogres->id) }}"
                          class='btn btn-info'>
                           <i class="far fa-edit"></i>
                       </a></td>
                       <td>@if ($viewall_studentsinprogres->status == null)
                        <span class="badge badge-secondary"> In progress</span>
                       @elseif($viewall_studentsinprogres->status = 'suspend')
                       <span class="badge badge-warning"> Suspended</span>
                       @elseif($viewall_studentsinprogres->status = 'reject')
