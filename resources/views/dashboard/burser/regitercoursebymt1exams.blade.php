                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach ($view_examsforcerts as $view_examsforcert)
                          @if ($view_examsforcert->registercourse['programname'] == 'MT' && $view_examsforcert->registercourse['semester'] == 'First Semester')
                          <tr>
                            ...
                            <td>{{ $view_examsforcert->registercourse['programname'] }}</td>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_examsforcerts as $view_examsforcert)
                        @if ($view_examsforcert->registercourse['programname'] == 'Diploma in Hardware Maintenance & Repairs' && $view_examsforcert->registercourse['semester'] == 'Second Semester')
                        <tr>
                          <td><a href="viewstudentsexams/{{ $view_examsforcert->student['ref_no'] }}">{{ $view_examsforcert->student['surname'] }}</a></td>
                          <td>{{ $view_examsforcert->student['fname'] }}</td>
                          <td>{{ $view_examsforcert->student['middlename'] }}</td>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach ($view_examsforcerts as $view_examsforcert)
                          @if ($view_examsforcert->registercourse['programname'] == 'Diploma in Hardware Maintenance & Repairs' && $view_examsforcert->registercourse['semester'] == 'Third Semester')
                          <tr>
                            <td><a href="viewstudentsexams/{{ $view_examsforcert->student['ref_no'] }}">{{ $view_examsforcert->student['surname'] }}</a></td>
                            <td>{{ $view_examsforcert->student['fname'] }}</td>
                            <td>{{ $view_examsforcert->student['middlename'] }}</td>
