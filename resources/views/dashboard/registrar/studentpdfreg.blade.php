  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Admitted Student</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">All Admitted Student</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  {{-- <h4>
                    ...
                    <small class="float-right">Date: 66/335</small>
                  </h4> --}}
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="printallspdf" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
