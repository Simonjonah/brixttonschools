    ...
    <section class="content">
      <h2>Dear {{ Auth::guard('web')->user()->fname }} continue your registration</h2>
                    ...
                    <div class="tab-pane" id="settings">
                      <form class="form-horizontal" action="{{ url('web/updatewebweb/'.Auth::guard('web')->user()->ref_no) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ Auth::guard('web')->user()->contactaddress }}" name="contactaddress" id="inputName2" placeholder="Address">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="file" name="passpot" value="{{ Auth::guard('web')->user()->passpot }}" class="form-control" id="inputName2" placeholder="profileimage">
                          </div>
                        </div>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="settings">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="logalgovt" value="{{ Auth::guard('web')->user()->logalgovt }}" class="form-control" id="inputName" placeholder="L.G Area">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputName" class="col-sm-2 col-form-label"> nationality</label>
                            <div class="col-sm-10">
                              <input type="text" name="nationality" value="{{ Auth::guard('web')->user()->nationality }}" class="form-control" id="inputName" placeholder="Natioality">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail" class="col-sm-2 col-form-label">contactaddress</label>
                            <div class="col-sm-10">
                              <input type="text" name="contactaddress" value="{{ Auth::guard('web')->user()->contactaddress }}" class="form-control" id="inputEmail" placeholder="Contact Address">
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="permanentaddress" value="{{ Auth::guard('web')->user()->permanentaddress }}" class="form-control" id="inputSkills" placeholder="Permanent Address">
                            </div>
                          </div>
                          <div class="form-group row">
