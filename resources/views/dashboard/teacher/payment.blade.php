        ...
        <section class="content">
            ...
            <div class="card-body">
                ...
                <div class="col-12 col-sm-6">
                    <h3 class="d-inline-block d-sm-none">{{ $single_videos->course_title }}</h3>
                    <div class="col-12">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <p>Date Registered {{ $single_videos->created_at->format('D d, M Y, H:i') }}</p>
                    ...
                    <label class="btn btn-default text-center">
                        ...
                        <br>
                        {{ $single_videos->course_period }}
                    </label>
                    <label class="btn btn-default text-center">
                        <input type="radio" name="color_option" id="color_option1" autocomplete="off">
                        <span class="text-xl">Course Title</span>
                        <br>
                        {{ $single_videos->course_title }}
                    </label>
                    ...
                    <div class="mt-4">
                        ...
                        {{-- <a href="../courseregistration/{{ $single_videos->slug }}" class="btn btn-primary">Register Now</a>                 --}}
                    </div>
                </div>
                </div>
                <div class="row mt-4">
