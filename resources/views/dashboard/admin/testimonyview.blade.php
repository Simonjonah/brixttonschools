                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" @error('student_firstname')
                        @enderror value="{{ $view_singletestimonies->student_firstname }}" name="student_firstname" placeholder="Stusent First Name">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" @error('student_lastname')
                        @enderror value="{{ $view_singletestimonies->student_lastname }}" name="student_lastname" placeholder="Stusent Last Name">
                      </div>
                    </div>
