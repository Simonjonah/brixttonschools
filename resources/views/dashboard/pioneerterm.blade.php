              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @if ($view_term->centername == Auth::guard('web')->user()->centername &&  $view_term->entrylevel == Auth::guard('web')->user()->entrylevel && $view_term->classname == Auth::guard('web')->user()->classname)
                        <tr>
